    	...
    	try {
        	if(msg instanceof String){
        		...
        		if(SUCCESS_KEY.equals(ret)){
        			...
        			//如果在服务端认证失败，这里会收到认证失败信息并由于服务端调用addListener(ChannelFutureListener.CLOSE)，所以客户端被断开连接
        			System.out.println(msg);
...
//				memoryMap.put("free", mem.getFree() / 1024L);
				memoryMap.put("mem_test", "mem_test_value");
				cpuPercMap.put("cpu_test", "cpu_test_value");
